function setPhotos(){
    for(let i=1;i<65;i++){
       ...
       pic.setAttribute("src",`../images/graduates${i}.png`)
    ...
    myBtn3.onclick = function() {
       if(!checkValidField(emailField)||!checkValidField(telField)||!checkValidField(nameField))
       return false
    ...
    btn.onclick = function() {
      if(!checkValidField(emailField3)||!checkValidField(telField3)||!checkValidField(nameField3))
         return false
      ...
      btn1.onclick = function() {
        if(!checkValidField(emailField2)||!checkValidField(telField2)||!checkValidField(nameField2))
              return false
